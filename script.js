...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key === 'ArrowDown' || e.key === 'ArrowUp') {
        ...
        const sections = ['home', 'about-anemia', 'symptoms', 'prevention', 'food-guide', 'lifestyle', 'quiz'];
...
function showQuizResult() {
    ...
    let message = '';
    if (quizScore === 3) {
        message = '🎉 Luar biasa! Kamu sudah memahami pencegahan anemia dengan sangat baik!';
    } else if (quizScore === 2) {
        message = '👍 Bagus! Kamu sudah cukup memahami tentang anemia. Terus belajar ya!';
    } else {
        message = '💪 Jangan menyerah! Baca lagi materi di atas untuk memahami pencegahan anemia lebih baik.';
    }
...
console.log('%c🩸 Cegah Anemia Website', 'color: #E53E3E; font-size: 20px; font-weight: bold;');
console.log('%cWebsite ini dibuat dengan ❤️ untuk edukasi pencegahan anemia pada remaja', 'color: #6C757D; font-size: 14px;');
